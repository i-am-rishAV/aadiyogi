                                    ...
                                    <!-- <button type="button" class="btn btn-dark btn-set-task w-sm-100"
                                        data-bs-toggle="modal" data-bs-target="#addprice"><i
                                            ...
                                            <button type="button" class="btn btn-dark btn-set-task w-sm-100" data-bs-toggle="modal" data-bs-target="#addservice">
                                               <i class="icofont-plus-circle me-2 fs-6"></i> Add Blog
                                                   </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title fw-bold" id="exampleModalLabel">Add Blog  <span style="color:red; padding-left:40px; font-size:20px;">*(required sections)</span></h5>
                            ...
                            <form id = "myform" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="description">Content<span style="color:red; padding-left:10px;">*</span></label>
                                    <textarea type="text" class="form-control" name="content" id="content" placeholder="Enter content"></textarea>
                                    <!-- <script>
                                    ClassicEditor
                        ...
                        <div class="modal-content">
                            ...
                            <form id = "myform" enctype="multipart/form-data">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="content" id="update_title" placeholder="Enter title">
                                </div>

                                
                                <div class="mb-3">
                                    <label for="description">Content<span style="color:red;">*</span></label>
                                    <textarea type="text" class="form-control" name="content" id="update_content" placeholder="Enter description"></textarea>
                                </div>
                                </form>
